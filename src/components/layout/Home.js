            ...
            <div class="col-md-12 col-lg-6 text-center text-md-left margins">
              <div class="white-text">
                <h1 class="h1-responsive font-weight-bold mt-md-5 mt-0 wow fadeInLeft animated" data-wow-delay="0.3s" className="landing">Nawodaya
                  ...
                  <h1 class="h1-responsive font-weight-bold mt-md-5 mt-0 wow fadeInLeft animated" data-wow-delay="0.3s" className="landing">Hospital
                  </h1>              
                ...
                <a href="/login" class="btn btn-unique btn-rounded font-weight-bold ml-lg-0 wow fadeInLeft waves-effect waves-light animated" data-wow-delay="0.3s" style={{visibility: 'visible', animationName: 'fadeInLeft' ,animationDelay: "0.3s"}}>Login</a>
              </div>
            </div>
