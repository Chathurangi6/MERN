          ...
          <div class="row flex-center pt-5 mt-3">
            <div class="col-md-12 col-lg-6 text-center text-md-left margins">
              <div class="white-text">
                ...
                <p class="wow fadeInLeft mb-3 animated" data-wow-delay="0.3s" className='paragraph'>Lorem ipsum dolor sit amet, consectetur
                  adipisicing elit. Rem repellendus quasi fuga nesciunt
                  dolorum nulla magnam veniam sapiente, fugiat! Commodi sequi non animi ea dolor molestiae
                  iste.
                </p>     
                <a href="/login" class="btn btn-unique btn-rounded font-weight-bold ml-lg-0 wow fadeInLeft waves-effect waves-light animated" data-wow-delay="0.3s" style={{visibility: 'visible', animationName: 'fadeInLeft' ,animationDelay: "0.3s",backgroundColor:'purple'}}>Login</a>
              </div>
            </div>
